...
class HtmlParser
  ...
  def content
    ...
    # The map method takes an array and returns a new one with values returne by the block. 
...
class Classifier
  ...
  def initialize(data)
    ...
    # I'm *unsure* of this, but I believe File.dirname(__FILE__) returns the corrent directory of this script.
  ...
  private
    def score(word_weights, words)
      ...
      # In the end, this gives us the score for this articles text in the terms of the current category being tested for.
